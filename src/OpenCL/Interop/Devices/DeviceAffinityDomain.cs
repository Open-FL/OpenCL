...
namespace OpenCL.NET.Interop.Devices
{
    ...
    public enum DeviceAffinityDomain : ulong
    {
        ...
        /// <summary>
        ///     Split the device along the next partitionable affinity domain. The implementation shall find the first level along
        ///     which the device or sub-device may be further subdivided in the order NUMA, L4, L3, L2, L1, and partition the

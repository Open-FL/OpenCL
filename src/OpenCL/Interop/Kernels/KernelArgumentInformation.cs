namespace OpenCL.NET.Interop.Kernels
{
    ...
    public enum KernelArgumentInformation : uint
    {
        ...
        /// <summary>
        ///     The type name specified for the argument. The type name returned will be the argument type name as it was declared
        ///     with any whitespace removed. If argument type name is an unsigned scalar type (i.e. unsigned char, unsigned short,
        ///     unsigned int, unsigned long), uchar, ushort, uint and ulong will be returned. The argument type name returned does

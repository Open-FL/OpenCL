namespace OpenCL.NET.Interop.Kernels
{
    ...
    public enum KernelExecutionInformation : uint
    {
        ...
        ///     <see cref="SetKernelExecutionInformation" /> for coarse-grain and fine-grain buffer SVM allocations but not for
        ///     fine-grain system SVM allocations.
        /// </summary>
        SvmPointers = 0x11B6,

        /// <summary>
        ///     This flag indicates whether the kernel uses pointers that are fine grain system SVM allocations. These fine grain
        ///     system SVM pointers may be passed as arguments or defined in SVM buffers that are passed as arguments to the
        ///     kernel.
        /// </summary>

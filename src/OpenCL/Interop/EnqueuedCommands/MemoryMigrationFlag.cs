...
namespace OpenCL.NET.Interop.EnqueuedCommands
{
    ...
    public enum MemoryMigrationFlag : ulong
    {
        ...
        /// <summary>
        ///     This flag indicates that the contents of the set of memory objects are undefined after migration. The specified set
        ///     of memory objects are migrated to the device associated with the command queue without incurring the overhead of

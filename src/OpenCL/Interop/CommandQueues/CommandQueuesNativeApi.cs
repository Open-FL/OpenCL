...
namespace OpenCL.NET.Interop.CommandQueues
{
    ...
    public static class CommandQueuesNativeApi
    {
        ...
        /// <param name="device">
        ///     Must be a device associated with <see cref="context" />. It can either be in the list of devices specified when
        ///     <see cref="context" /> is created using <see cref="CreateContext" /> or have the same device type as the device
        ///     type
        ///     specified when the context is created using <see cref="CreateContextFromType" />.
        /// </param>
        /// <param name="properties">
        ///     Specifies a list of properties for the command-queue. This is a bit-field described in below. Only command-queue
        ///     properties specified below can be set in properties; otherwise the value specified in properties is considered to
        ///     be
        ///     not valid.
        ///     <c>Result.QueueOutOfOrderExecutionModeEnable</c>: Determines whether the commands queued in the command-queue are
        ///     executed in-order or out-of-order. If set, the commands in the command-queue are executed out-of-order. Otherwise,
        ///     commands are executed in-order.
        ///     <c>Result.QueueProfilingEnable</c>: Enable or disable profiling of commands in the command-queue. If set, the
        ...
        /// </param>
        /// <returns>
        ///     Returns a valid non-zero command-queue and <see cref="errorCode" /> is set to <c>Result.Success</c> if the
        ///     command-queue is created successfully. Otherwise, it returns a <c>null</c> value with an error values returned in
        ///     <see cref="errorCode" />.
        /// </returns>
        ...
        /// <param name="context">Must be a valid OpenCL context.</param>
        /// <param name="device">
        ///     Must be a device or sub-device associated with <see cref="context" />. It can either be in the list of devices and
        ///     sub-devices specified when <see cref="context" /> was created using <see cref="CreateContext" /> or be a root
        ///     device
        ///     with the same device type as specified when the context is created using <see cref="CreateContextFromType" />.
        /// </param>
        /// <param name="properties">
        ///     Specifies a list of properties for the command-queue and their corresponding values. Each property name is
        ///     immediately followed by the corresponding desired value. The list is terminated with 0. If a supported property and
        ///     its
        ///     value is not specified in properties, its default value will be used. <see cref="properties" /> can be <c>null</c>
        ...
        ///     specified by <see cref="parameterValueSize" /> is less than the size of the return type
        ///     <see cref="parameterValue" />
        ...
        /// <returns>
        ///     Returns <c>Result.Success</c> if the function call was executed successfully. Otherwise, it returns one of the
        ///     following errors:

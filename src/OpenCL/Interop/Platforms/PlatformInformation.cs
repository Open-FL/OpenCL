namespace OpenCL.NET.Interop.Platforms
{
    ...
    public enum PlatformInformation : uint
    {
        ...
        ///     defined as part of the core specification and does not require any extensions to be supported). EMBEDDED_PROFILE -
        ...
        ///     following format: "OpenCL[space][major_version.minor_version][space][platform-specific information].
        /// </summary>
        Version = 0x0901,
        ...
        ///     <see cref="NativeMethods.GetDeviceAndHostTimer" />.
        /// </summary>
        PlatformHostTimerResolution = 0x0905,

        /// <summary>
        ///     If the cl_khr_icd extension is enabled, the function name suffix used to identify extension functions to be

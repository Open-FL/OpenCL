...
namespace OpenCL.NET.Interop.Platforms
{
    ...
    public static class PlatformsNativeApi
    {
        ...
        ///     The number of platform entries that can be added to <see cref="platforms" />. If
        ///     <see cref="platforms" /> is not <c>null</c>, the <see cref="numberOfEntries" /> must be greater than zero.
        /// </param>
        /// <param name="platforms">
        ///     Returns a list of OpenCL platforms found. The platform values returned in <see cref="platforms" /> can be used to
        ///     identify a specific OpenCL platform. If <see cref="platforms" /> argument is <c>null</c>, this argument is ignored.
        ///     The number of OpenCL platforms returned is the mininum of the value specified by <see cref="numberOfEntries" /> or
        ///     the number of OpenCL platforms available.
        /// </param>
        /// <param name="numberOfPlatforms">
        ///     Returns the number of OpenCL platforms available. If <see cref="numberOfPlatforms" />
        ///     is <c>null</c>, this argument is ignored.
        /// </param>
        /// <returns>
        ///     Returns <c>Result.Success</c> if the function is executed successfully. If the cl_khr_icd extension is enabled,
        ///     <see cref="GetPlatformIds" /> returns <c>Result.Success</c> if the function is executed successfully and there are
        ///     a
        ///     non zero number of platforms available. Otherwise it returns one of the following errors:
        ///     <c>Result.InvalidValue</c> if <see cref="numberOfEntries" /> is equal to zero and <see cref="platforms" /> is not
        ///     <c>null</c>, or if both <see cref="numberOfPlatforms" /> and <see cref="platforms" /> are <c>null</c>.
        ...
        /// </summary>
        /// <param name="platform">
        ///     The platform ID returned by <see cref="GetPlatformIds" /> or can be <c>null</c>. If
        ...
        ///     This size in bytes must be greater than or equal to size of return type specified above.
        /// </param>
        /// <param name="parameterValue">
        ///     A pointer to memory location where appropriate values for a given
        ///     <see cref="parameterValue" /> will be returned. If <see cref="parameterValue" /> is <c>null</c>, it is ignored.
        /// </param>
        ...
        /// </param>
        /// <returns>
        ///     Returns <c>Result.Success</c> if the function is executed successfully. Otherwise, it returns the following: (The
        ///     OpenCL specification does not describe the order of precedence for error codes returned by API calls)

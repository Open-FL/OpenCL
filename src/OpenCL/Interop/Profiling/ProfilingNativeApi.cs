...
namespace OpenCL.NET.Interop.Profiling
{
    ...
    public static class ProfilingNativeApi
    {
        ...
        ///     <c>Result.ProfilingInformationNotAvailable</c> if the <c>CommandQueueProperty.ProfilingEnable</c> flag is not set
        ///     for the command-queue, if the execution status of the command identified by event is not complete or if

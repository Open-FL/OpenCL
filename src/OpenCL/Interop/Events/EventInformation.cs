namespace OpenCL.NET.Interop.Events
{
    ...
    public enum EventInformation : uint
    {
        ...
        ///     associated
        ///     with any OpenCL command queue. If the cl_khr_egl_event extension is enabled, the CL_EVENT_COMMAND_QUEUE of a linked
        ///     event is <c>null</c>, because the event is not associated with any OpenCL command queue.
        /// </summary>
        CommandQueue = 0x11D0,
        ...
        /// <summary>
        ///     The event reference count. The reference count returned should be considered immediately stale. It is unsuitable

namespace OpenCL.NET.Interop.Memory
{
    ...
    public enum ImageInformation : uint
    {
        ...
        /// <summary>
        ///     Return size of each element of the image memory object given by image in bytes. An element is made up of n
        ///     channels. The value of n is given in image format descriptor.
        /// </summary>
        ElementSize = 0x1111,
        ...
        /// <summary>
        ///     Return calculated slice pitch in bytes of a 2D slice for the 3D image object or size of each image in a 1D or 2D
        ///     image array given by image. For a 1D image, 1D image buffer and 2D image object return 0.
        /// </summary>
        SlicePitch = 0x1113,
        ...
        /// <summary>
        ///     Return depth of the image in pixels. For a 1D image, 1D image buffer, 2D image or 1D and 2D image array object,
        ///     depth = 0.
        /// </summary>
        Depth = 0x1116,

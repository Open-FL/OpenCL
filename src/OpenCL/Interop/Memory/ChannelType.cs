namespace OpenCL.NET.Interop.Memory
{
    ...
    public enum ChannelType : uint
    {
        ...
        /// <summary>
        ///     Represents a normalized 5-6-5 3-channel RGB image. The channel order must be <c>ChannelOrder.Rgb</c> or
        ///     <c>ChannelOrder.Rgbx</c>.
        /// </summary>
        NormalizedUnsignedShortFloat565 = 0x10D4,

        /// <summary>
        ///     Represents a normalized x-5-5-5 4-channel xRGB image. The channel order must be <c>ChannelOrder.Rgb</c> or
        ///     <c>ChannelOrder.Rgbx</c>.
        /// </summary>
        NormalizedUnsignedShortFloat555 = 0x10D5,

        /// <summary>
        ///     Represents a normalized x-10-10-10 4-channel xRGB image. The channel order must be <c>ChannelOrder.Rgb</c> or
        ///     <c>ChannelOrder.Rgbx</c>.
        /// </summary>
        ...
        /// <summary>
        ///     Represents a different version of a normalized x-10-10-10 4-channel xRGB image. The channel order must be

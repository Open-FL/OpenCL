namespace OpenCL.NET.Interop.Memory
{
    ...
    public enum MemoryObjectInformation : uint
    {
        ...
        /// <summary>
        ///     The map count. The map count returned should be considered immediately stale. It is unsuitable for general use in
        ///     applications. This feature is provided for debugging.
        /// </summary>
        MapCount = 0x1104,

        /// <summary>
        ///     The reference count. The reference count returned should be considered immediately stale. It is unsuitable for
        ...
        /// <summary>
        ///     <c>true</c> if the memory object is a buffer object that was created with <c>MemoryFlag.UseHostPointer</c> or is a
        ///     subbuffer object of a buffer object that was created with <c>MemoryFlag.UseHostPointer</c> and the

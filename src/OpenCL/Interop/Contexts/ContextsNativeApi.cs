...
namespace OpenCL.NET.Interop.Contexts
{
    ...
    public static class ContextsNativeApi
    {
        ...
        ///     followed by the corresponding desired value. The list is terminated with 0. <see cref="properties" /> can be
        ///     <c>null</c>
        ...
        ///     implementation to report information on errors during context creation as well as errors that occur at runtime in
        ///     this context. This callback function may be called asynchronously by the OpenCL implementation. It is the
        ///     application's responsibility to ensure that the callback function is thread-safe. If
        ///     <see cref="notificationCallback" />
        ///     is <c>null</c>, no callback function is registered. The parameters to this callback function are:
        ///     errinfo is a pointer to an error string.
        ///     private_info and cb represent a pointer to binary data that is returned by the OpenCL implementation that can be
        ///     used to log additional information helpful in debugging the error.
        ///     userData is a pointer to user supplied data.
        ///     Note: There are a number of cases where error notifications need to be delivered due to an error that occurs
        ///     outside a context. Such notifications may not be delivered through the <see cref="notificationCallback" />
        ///     callback.
        ///     Where these notifications go is implementation-defined.
        /// </param>
        /// <param name="userData">
        ///     Passed as the userData argument when <see cref="notificationCallback" /> is called.
        ...
        /// </param>
        /// <returns>
        ///     Returns a valid non-zero context and <see cref="errorCode" /> is set to <c>Result.Success</c> if the context is
        ...
        /// <param name="properties">
        ///     Specifies a list of context property names and their corresponding values. Each property name is immediately
        ///     followed by the corresponding desired value. <see cref="properties" /> can also be <c>null</c> in which case the
        ...
        ///     private_info and cb represent a pointer to binary data that is returned by the OpenCL implementation that can be
        ///     used to log additional information helpful in debugging the error.
        ///     user_data is a pointer to user supplied data. There are a number of cases where error notifications need to be
        ///     delivered due to an error that occurs outside a context. Such notifications may not be delivered through the
        ///     <see cref="notificationCallback" /> callback. Where these notifications go is implementation-defined.
        /// </param>
        /// <param name="userData">
        ///     Passed as the user_data argument when <see cref="notificationCallback" /> is called.
        ///     <see cref="userData" /> can be <c>null</c>.
        /// </param>
        /// <param name="errorCode">
        ///     Return an appropriate error code. If <see cref="errorCode" /> is <c>null</c>, no error code is
        ///     returned.
        /// </param>
